...
pr.0M.chain <- logistic(post2$a_mu + post2$b1*0 + post2$b2*0 + post2$b3*0 + post2$b9)
pr.0P.chain <- logistic(post2$a_mu + post2$b1*0 + post2$b2*1 + post2$b3*0 + post2$b9)
pr.1M.chain <- logistic(post2$a_mu + post2$b1*1 + post2$b2*0 + post2$b3*0 + post2$b9)
pr.1P.chain <- logistic(post2$a_mu + post2$b1*1 + post2$b2*1 + post2$b3*1 + post2$b9)
...
polygon(c(0.7, 0.7, 1.3, 1.3), c(0, pr.0M.mean, pr.0M.mean, 0), col='steelblue', border=NA)
polygon(c(1.7, 1.7, 2.3, 2.3), c(0, pr.1M.mean, pr.1M.mean, 0), col='steelblue', border=NA)

polygon(c(4.7, 4.7, 5.3, 5.3), c(0, pr.0P.mean, pr.0P.mean, 0), col='sandybrown', border=NA)
polygon(c(5.7, 5.7, 6.3, 6.3), c(0, pr.1P.mean, pr.1P.mean, 0), col='sandybrown', border=NA)
...
pr.00M.chain <- logistic(post3$a_mu + post3$b1*0 + post3$b2*0 + post3$b3*0 
	+ post3$b4*0 + post3$b5*0 + post3$b11)
pr.00P.chain <- logistic(post3$a_mu + post3$b1*0 + post3$b2*0 + post3$b3*1 
	+ post3$b4*0 + post3$b5*0 + post3$b11)
pr.10M.chain <- logistic(post3$a_mu + post3$b1*1 + post3$b2*0 + post3$b3*0 
	+ post3$b4*0 + post3$b5*0 + post3$b11)
pr.10P.chain <- logistic(post3$a_mu + post3$b1*1 + post3$b2*0 + post3$b3*1 
	+ post3$b4*1 + post3$b5*0 + post3$b11)
pr.11M.chain <- logistic(post3$a_mu + post3$b1*0 + post3$b2*1 + post3$b3*0 
	+ post3$b4*0 + post3$b5*0 + post3$b11)
pr.11P.chain <- logistic(post3$a_mu + post3$b1*0 + post3$b2*1 + post3$b3*1 
	+ post3$b4*0 + post3$b5*1 + post3$b11)
...
plot(1:6, ylim=c(0,0.5), ylab='Annual Probability of Birth', xlab='Sex of First Child', 
...
plot(1:8, ylim=c(0,0.05), ylab='Annual Probability of Birth', 
	xlab='Sex Combination at Parity 2', xaxt='n', col=NULL, xlim=c(0, 9), frame.plot=FALSE, las=1)

abline(h=0:10/10, col=gray(0.8))

polygon(c(0.7, 0.7, 1.3, 1.3), c(0, pr.00M.mean, pr.00M.mean, 0), col='steelblue', border=NA)
polygon(c(1.7, 1.7, 2.3, 2.3), c(0, pr.10M.mean, pr.10M.mean, 0), col='steelblue', border=NA)
polygon(c(2.7, 2.7, 3.3, 3.3), c(0, pr.11M.mean, pr.11M.mean, 0), col='steelblue', border=NA)

polygon(c(5.7, 5.7, 6.3, 6.3), c(0, pr.00P.mean, pr.00P.mean, 0), col='sandybrown', border=NA)
polygon(c(6.7, 6.7, 7.3, 7.3), c(0, pr.10P.mean, pr.10P.mean, 0), col='sandybrown', border=NA)
polygon(c(7.7, 7.7, 8.3, 8.3), c(0, pr.11P.mean, pr.11P.mean, 0), col='sandybrown', border=NA)
...
pr.homog.mat.chain <- logistic(post5$a_mu + post5$b1*0 + post5$b2*0 + post5$b3*0 + post5$b9)
pr.mixed.mat.chain <- logistic(post5$a_mu + post5$b1*1 + post5$b2*0 + post5$b3*0 + post5$b9)
pr.homog.pat.chain <- logistic(post5$a_mu + post5$b1*0 + post5$b2*1 + post5$b3*0 + post5$b9)
pr.mixed.pat.chain <- logistic(post5$a_mu + post5$b1*1 + post5$b2*1 + post5$b3*1 + post5$b9)
